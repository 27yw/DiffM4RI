...
class DiTBlock(nn.Module):
    ...
    """
    def __init__(self, hidden_size, num_heads, mlp_ratio=4.0,input_size=None,**block_kwargs):
        super().__init__()
...
class DiT(nn.Module):
    ...
    def initialize_weights(self):
        ...
        pos_embed = get_3d_sincos_pos_embed(self.pos_embed.shape[-1], int(self.x_embedder.grid_size[0]))
        #print(pos_embed.shape)
        #print(self.x_embedder.num_patches **(1/3))
    ...
    def unpatchify(self, x):
        ...
        #print(x.shape[1])
        # python 计算除不尽所以加一
        h = w = d = int(self.input_size // self.patch_size)
        #print(h)
